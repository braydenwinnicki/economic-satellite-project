...
def main():
    ...
    # compute normalization statistics from training tracts
    ...
    predictions_dollars = [
        p * std_income + mean_income for p in all_predictions
    ]
    targets_dollars = [
        t * std_income + mean_income for t in all_targets
    ]
    ...
    results.to_csv("/Users/braydenwinnicki/Desktop/econ_project/results/resnet_unfrozen_l3_results.csv", index=False)
